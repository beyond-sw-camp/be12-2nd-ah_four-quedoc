            ...
            <div class="member">
                <div class="form-box">
                    <div class="form-group">
                        ...
                        <div class="input-wrap side-btn">
                            <div class="input-wrap">
                                <v-text-field v-model="hospitalData.name" aria-label="병원이름" color="primary" density="comfortable"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <v-text-field v-model="hospitalData.type" aria-label="병원종류" color="primary" density="comfortable" hide-details="auto"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <v-text-field v-model="hospitalData.detailAddress" aria-label="병원종류" color="primary" density="comfortable" hide-details="auto"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <v-text-field v-model="hospitalData.phoneNumber" aria-label="전화번호" color="primary" density="comfortable" hide-details="auto"
                    ...
                    <div class="form-group">
                        ...
                        <v-autocomplete v-model="hospitalData.department" width=300 placeholder="진료과목" :items="departments"
                            variant="outlined"></v-autocomplete>
                    </div>
                    <div class="form-group">
                        <div class="ele-tit">
                        ...
                        <div class="data-wrap">
                            <v-chip-group v-model="hospitalData.selectedTags" selected-class="text-primary" multiple>
                                <v-chip style="font-size: small;" v-for="tag in tags" :key="tag" :text="tag"></v-chip>
                            </v-chip-group>
                        </div>
                        <div style="display: flex; margin-top: 2rem; width: 300px;">
                            <v-autocomplete v-model="hospitalData.openTime" width=30 placeholder="오픈시간" :items="timeData"
                                variant="outlined"></v-autocomplete>
                            <v-autocomplete v-model="hospitalData.closeTime" width=30 style="margin-left: 1rem;" placeholder="마감시간" :items="timeData"
                                variant="outlined"> </v-autocomplete>
                        </div>
                    </div>
                </div>
...
const submit = async () => {
    ...
    const response = await api.registerHsp(hospitalData);
...
const tags = ["월", "화", "수", "목", "금", "토", "일"]
const timeData = ["00:00", "00:30", "01:00", "01:30", "02:00", "02:30", "03:00", "03:30", "04:00", "04:30", "05:00", "05:30", "06:00", "06:30", "07:00", "07:30", "08:00", "08:30", "09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00", "18:30", "19:00", "19:30", "20:00", "20:30", "21:00", "21:30", "22:00", "22:30", "23:00", "23:30"]
const departments = ["내과", "외과", "정형외과", "신경외과", "피부과", "안과", "이비인후과", "비뇨기과", "산부인과", "소아청소년과", "치과", "한의원", "약국", "기타"]
...
// Watch: 첫 번째 값이 변경되면 두 번째, 세 번째 선택 초기화
watch(selectedCity, () => {
...
// 메서드: 주소 업데이트
const updateAddress = () => {
  hospitalData.address = selectedCity.value && selectedDistrict.value
